...
public class RegisterTest {
	...
	public static void main(String[] args) {
		...
		//List all the names in the register
		...
		//Remove a name from this register
		...
		//The amount of names in this register
		...
		//Family names that begin with this letter
		...
		//Checking to see if the register is empty or not
