...
public class PlayList {
    ...
    public void sortPlaylistReverse() {
    	songlist.sort(Comparator.reverseOrder());
    }
    
    public void sortPlaylistCustom() {
    		songlist.sort(Comparator.comparing(Song::getArtist)
    				  .thenComparingInt(Song::getDuration)
    				  .thenComparing(Song::getTitle).reversed()); 
    }
    
    /*	songlist.sort(Comparator.comparing((Song s) -> s.getArtist())
	  				.thenComparingInt((Song s) -> s.getDuration())
	  				.thenComparing((Song s) -> s.getTitle()));
*/
