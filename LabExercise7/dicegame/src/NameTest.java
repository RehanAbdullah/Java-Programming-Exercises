public class NameTest {
	...
	public static void main(String[] args) {
		...
		n.setFamilyName("Bond");
		System.out.println("Expected James: Actual: " + n.getFirstName());
		System.out.println("Expected Bond: Actual: " + n.getFamilyName());
		
		
		System.out.println("Testing custom constructor initialisation...");
		Name player = new Name("David", "Beckham");
		
		System.out.println("Testing get method for full name...");
		System.out.println("Expected David Beckham: Actual: " + player.getFullName());
